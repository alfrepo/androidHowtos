...
public class mHorizontalScrollView extends HorizontalScrollView {
	...
	protected void onDraw(Canvas canvas) {
		Log.d("MyActivity","draw HorizontalScrollView");
		super.onDraw(canvas);
	}
	//TODO debugging loop
	@Override
	protected void dispatchDraw(Canvas canvas) {
		Log.d("MyActivity","dispatchdraw HorizontalScrollView");
...
//HANDLING TOUCH EVENTS
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
	    ...
	    //and multi-touch is handled below in the view hierarchy - there is no situation in which an even should 100% belong to this view and not to views below in the view hierarchy.
	    boolean result = false;
