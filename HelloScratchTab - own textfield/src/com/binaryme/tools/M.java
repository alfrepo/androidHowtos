...
//		Log.d("MyActivity", "5 cm equals so much px: "+5*cm);
	...
	public static String getClassName(Class<?> fullClassPath){
		return getClassName(fullClassPath.toString());
	}
	public static String getClassName(String fullClassPath){
		try{
			String[] res = fullClassPath.split("\\."); //splits the classname by the dot character 
