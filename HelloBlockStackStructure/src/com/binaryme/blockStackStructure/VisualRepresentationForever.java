...
public class VisualRepresentationForever extends VisualRepresentation {

	public VisualRepresentationForever(Context context) {
		super(context);
	...
	protected void onDraw(Canvas canvas) {
		...
		ColorDrawable mDrawable = new ColorDrawable(Color.GREEN);		//create a new Rectangle
